...
df_ = pd.read_csv("C:\\Users\\bferid854\\PycharmProjects\\CRM_Analytics\\datasets\\flo_data_20k.csv")
df = df_.copy()
...
###############################################################
# 1.Veri setindeki en son alışverişin yapıldığı tarihten 2 gün sonrasını analiz tarihi olarak alınız.
df['last_order_date'].max() # Out[13]: Timestamp('2021-05-30 00:00:00')
...
# 2.  Gamma-Gamma modelini fit ediniz. Müşterilerin ortalama bırakacakları
# değeri tahminleyip exp_average_value olarak cltv dataframe'ine ekleyiniz.
